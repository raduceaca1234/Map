...
public class MainWindowController implements Initializable {
    ...
    private void changeProgramStateHandler(ProgramState currentProgState){
        ...
        try {
            ...
            populateSemaphore(currentProgState);
    ...
    private void populateSemaphore(ProgramState givenProgramState)
    {
        List<Triplet<Integer, List<Integer>, Integer>> symbolTableListed = new ArrayList<>(givenProgramState.getSemaphoreTable().getSemaphore().getContent().values());

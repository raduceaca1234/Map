...
public class SelectWindowController implements Initializable {
    ...
    private List<IStatement> initExamples(){
        ...
        IStatement forked1 = new CompoundStatement(new AssignmentStatement("v",new ValueExpression(new IntValue(2))),new PrintStatement(new VariableExpression("v")));
        IStatement forked2 = new CompoundStatement(new AssignmentStatement("v",new ValueExpression(new IntValue(3))),new PrintStatement(new VariableExpression("v")));

        IStatement ex12 = new CompoundStatement(new VariableDeclarationStatement("v",new IntType()),new CompoundStatement(new AssignmentStatement("v",new ValueExpression(new IntValue(1))),new CompoundStatement(new ForkStatement(forked1),new ForkStatement(forked2))));
